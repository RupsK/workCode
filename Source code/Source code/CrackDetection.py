...
#ConfusionMatrixDisplay( testX, y_pred)
...
#cm = confusion_matrix( testY, predIdxs, labels = lb.classes_)
#disp = ConfusionMatrixDisplay(confusion_matrix= cm, display_labels= lb.classes_)

# serialize the model to disk
print("[INFO] saving mask detector model...")
model.save("Crack_Detection;.model", save_format="h5")
...
plt.savefig("C:/Rupali Shinde/mask detection/Face-Mask-Detection-master/figuresfor concrete model.png")
